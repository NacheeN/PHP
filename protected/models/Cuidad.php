...
/**
 * This is the model class for table "cuidad".
 *
 * The followings are the available columns in table 'cuidad':
 * @property integer $id
 ...
 */
class Cuidad extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'barrios' => array(self::HAS_MANY, 'Barrio', 'id_cuidad'),
	 ...
	 * @return Cuidad the static model class
	 */
